...
def ai_move(level, board):
    ...
    if level == "Easy":
        ...
        # 50% chance for optimal move, 50% for random move
...
while True:
    ...
    # Let user choose difficulty level.
        ...
        mediumButton = pygame.Rect((width / 2) - (width / 8), (height / 2), width / 4, 50)
        ...
        hardButton = pygame.Rect(5 * (width / 8), (height / 2), width / 4, 50)
